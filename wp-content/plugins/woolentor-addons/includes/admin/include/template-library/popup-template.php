    ...
    <div id="htwpt-popup-area" class="woolentor-template-import-popup">
        ...
        <div class="httemplate-popupcontent">
            ...
            <div class="htwptpopupcontent">
                ...
                <# if ( data.templatetype !== 'other' ){ #>
                <p><?php esc_html_e( 'You can import the template either into the Elementor Template Library or the ShopLentor Builder.', 'woolentor' ); ?></p>
                <# }else{ #>
                    <p><?php esc_html_e( 'Import template to your Template Library.', 'woolentor' ); ?></p>
                <# } #>
                <span class="htwptimport-button-dynamic">{{{data.temImportButton}}}</span>
                <# if ( data.templatetype !== 'other' ){ #>
                    <span class="htwptimport-button-dynamic">{{{data.builderImportButton}}}</span>
                <# } #>
