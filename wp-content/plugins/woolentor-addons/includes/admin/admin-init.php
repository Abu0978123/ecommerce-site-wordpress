...
class Woolentor_Admin_Init{
    ...
    public function add_other_menu(){
        add_submenu_page(
            ...
            esc_html__('Upgrade to Pro', 'woolentor'), 
            'manage_options', 
            'https://woolentor.com/pricing/?utm_source=admin&utm_medium=notice&utm_campaign=free'
        );
    }
        ...
        $position = key(
			array_filter( $submenu['woolentor_page'],  
				static function( $item ) {
					return strpos( $item[2], 'https://woolentor.com/pricing/?utm_source=admin&utm_medium=notice&utm_campaign=free' ) !== false;
				}
			)
		);
