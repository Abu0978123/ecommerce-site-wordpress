...
<div id="woolentor-admin-pro-popup" class="woolentor-admin-popup">
    <div class="woolentor-admin-popup-inner">
        ...
        <a href="https://woolentor.com/pricing/?utm_source=admin&utm_medium=notice&utm_campaign=free" class="woolentor-admin-btn woolentor-admin-btn-primary" target="_blank"><?php echo esc_html__('Buy Now','woolentor'); ?></a>
    </div>
</div>